          ...
          <ul class="nav navbar-nav text-uppercase navbar-right" id="top-social-links">
            <li>
              <a href="https://facebook.com/socialvalueaotearoa" rel="Facebook">
                <img src="/membership/sites/all/themes/nexus/images/icon_facebook.svg" alt="Link In"/>
              </a>
              <a href="https://twitter.com/socialaotearoa" rel="Tweeter">
                <img src="/membership/sites/all/themes/nexus/images/icon_twitter.svg" alt="Link In"/>
              </a>
              <a href="https://nz.linkedin.com/in/socialvalueaotearoa" rel="Linked In">
                <img src="/membership/sites/all/themes/nexus/images/icon_linkedin.svg" alt="Link In"/>
              </a>
            </li>
            <li id="btn_member_login" class="text-capitalize">
              <a href="/membership/user/login" rel="Login">Member Login</a>
            </li>
          </ul>
                  ...
                  <div class="container">
                    <?php if($slide1_head || $slide1_desc) : ?>
                      ...
                      <div class="carousel-caption col-lg-5">
                        ...
                        <p><a class="btn btn-lg btn-primary" href="<?php print url($slide1_url); ?>" role="button"><?php print t('Find out more'); ?></a></p>
                      </div>
                      </div>
                    <?php endif; ?>
                  </div>
                  ...
                  <div class="container">
                    <?php if($slide2_head || $slide2_desc) : ?>
                      ...
                      <div class="row">
                        ...
                        <p><a class="btn btn-lg btn-primary" href="<?php print url($slide3_url); ?>" role="button"><?php print t('Find out more'); ?></a></p>
                      </div>
                      </div>
                    <?php endif; ?>
                  </div>
            ...
            <div class="vcenter-parent">
              <div class="vcenter">
                <div class="content-about col-lg-4 col-lg-offset-4">
                  ...
                  <p><a class="btn btn-lg btn-primary" href="about/10" role="button">About us</a></p>
                </div>
              </div>
            </div>
          </div>
